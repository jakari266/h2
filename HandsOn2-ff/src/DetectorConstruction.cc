...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    // =============================================
   // G4Material* CsI1 = G4Material::GetMaterial("CSI");
    //  G4Material* CsI1 = G4Material::GetMaterial("G4_PLASTIC_SC_VINYLTOLUENE");
   // G4Material* CsI1 = G4Material::GetMaterial("G4_Pb");
   
     G4VSolid* caloSolid  = new G4Box("calorimeter",1.5*m,0.3*m,0.5*m);
    G4LogicalVolume* caloLogical = new G4LogicalVolume(caloSolid,argonGas,"caloLogical");
    new G4PVPlacement(0,G4ThreeVector(0.,0.,3.*m),caloLogical,"caloPhysical",secondArmLogical,
                      false,0,checkOverlaps);
    
    // visualization attributes ------------------------------------------------
    
    G4VisAttributes* visAttributes = new G4VisAttributes(G4Colour(1.0,1.0,1.0));
    visAttributes->SetVisibility(false);// agar true shavad hajme madar ra neshan midahad
    worldLogical->SetVisAttributes(visAttributes);
    fVisAttributes.push_back(visAttributes);
    
    visAttributes = new G4VisAttributes(G4Colour(1.0,1.0,1.0));
    visAttributes->SetVisibility(false);// agar true shavad hajme first va seconf ra neshan midahad
    ...
    fVisAttributes.push_back(visAttributes);
    /////////////////////////////////////////////////////////////////
    visAttributes = new G4VisAttributes(G4Colour(0.50,0.0,1.0));
    caloLogical->SetVisAttributes(visAttributes);
    fVisAttributes.push_back(visAttributes);
    /////////////////////////////////////////////////////////////////
...
void DetectorConstruction::ConstructMaterials()
{
    ...
    // =============================================
    G4Element* elCs = new G4Element("seziom","Cs",55,132.9*g/mole);
    G4Element* elI = new G4Element("iodide","I",53,126.9*g/mole);
    G4Material* CsI= new G4Material("CSI",4.51*g/cm3,2);//  g/mole bezanim bebinim chi mishe vaghti material print mikonim 
